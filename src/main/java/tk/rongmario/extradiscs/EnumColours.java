...
public enum EnumColours
{
	...
	public static EnumColours[] DYES = new EnumColours[] {BLACK, DARK_RED, DARK_GREEN, null, DARK_BLUE, PURPLE, DARK_AQUA, GREY, DARK_GREY, PINK, BRIGHT_GREEN, YELLOW, INDIGO, RED, ORANGE, WHITE};
	...
	private EnumColours(String s, String n, int[] rgb, int meta)
	{
		code = s;
		unlocalizedName = n;
		rgbCode = rgb;
